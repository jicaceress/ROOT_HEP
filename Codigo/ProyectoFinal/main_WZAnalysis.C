...
{
    TString path = "/home/ivan/Documentos/Root_HEP/";
    ...
    chain_ZqqZll->Process("WZAnalysis.C+","ZqqZll");
    ...
    chain_WqqZll->Process("WZAnalysis.C+","WqqZll");
    ...
    chain_WpqqWmlv->Process("WZAnalysis.C+","WpqqWmlv");
    ...
    chain_WplvWmqq->Process("WZAnalysis.C+","WplvWmqq");
    ...
    chain_Ztautau->Process("WZAnalysis.C+","Ztautau");
    }// option 2
    ...
    chain_single_top_tchan->Process("WZAnalysis.C+","single_top_tchan");
    ...
    chain_single_antitop_tchan->Process("WZAnalysis.C+","single_antitop_tchan");
    ...
    chain_single_top_schan->Process("WZAnalysis.C+","single_top_schan");
    ...
    chain_single_antitop_schan->Process("WZAnalysis.C+","single_antitop_schan");
    ...
    chain_single_top_wtchan->Process("WZAnalysis.C+","single_top_wtchan");
    ...
    chain_single_antitop_wtchan->Process("WZAnalysis.C+","single_antitop_wtchan");
    ...
    chain_Wplusenu->Process("WZAnalysis.C+","Wplusenu");
    ...
    chain_Wplusmunu->Process("WZAnalysis.C+","Wplusmunu");
    ...
    chain_Wplustaunu->Process("WZAnalysis.C+","Wplustaunu");
    ...
    chain_Wminusenu->Process("WZAnalysis.C+","Wminusenu");
    ...
    chain_Wminusmunu->Process("WZAnalysis.C+","Wminusmunu");
    ...
    chain_Wminustaunu->Process("WZAnalysis.C+","Wminustaunu");
    } // option 3
